...
export function ProfileAvatar({ src, alt, initials = "JT" }) {
    ...
    return (
        <div className="relative w-64 h-64 sm:w-80 sm:h-80">
            {/* Subtle glow */}
            <div className="absolute -inset-3 rounded-full bg-[radial-gradient(circle_at_top,rgba(99,102,241,0.28),transparent_60%)] blur-xl" />
            ...
            <div className="relative w-full h-full rounded-full p-[3px] bg-[conic-gradient(from_180deg,rgba(99,102,241,0.85),rgba(236,72,153,0.45),rgba(99,102,241,0.85))]">
                {/* Inner */}
                <div className="relative w-full h-full rounded-full overflow-hidden bg-gray-900 ring-1 ring-white/10 shadow-[0_18px_60px_rgba(0,0,0,0.55)]">
                    {/* Glass highlight */}
